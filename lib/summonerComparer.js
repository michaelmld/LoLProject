...
exports.compareCommonChampions = (commonChampions) => {
    var finalWinner = 0;
    var championCompareList = commonChampions.map(([championA, championB]) => {
        ...
        return {
            ...
            statList: [winPercentage, championKills, damageDealt, creepScore,
...
var compareWinPercentages = (summonerAStats, summonerBStats) => {
...
var compareChampionKills = (summonerAStats, summonerBStats) => {
...
var compareDamageDealt = (summonerAStats, summonerBStats) => {
...
var compareMinionsKilled = (summonerAStats, summonerBStats) => {
...
var compareAverageDeaths = (summonerAStats, summonerBStats) => {
    var summonerAAvgDeaths = summonerAStats.totalDeathsPerSession/summonerAStats.totalSessionsPlayed;
    var summonerBAvgDeaths = summonerBStats.totalDeathsPerSession/summonerBStats.totalSessionsPlayed;
...
var compareGoldEarned = (summonerAStats, summonerBStats) => {
...
var compareTurretsKilled = (summonerAStats, summonerBStats) => {
...
var comparePhysicalDamage = (summonerAStats, summonerBStats) => {
...
var compareMagicalDamage = (summonerAStats, summonerBStats) => {
...
var compareAssists = (summonerAStats, summonerBStats) => {
...
var getWinnerOffset = (offset) => {
    return (offset > 0 ? 1 : (offset < 0 ? -1 : 0));
}

var createResultObject = (summonerStatA, summonerStatB, category, reason, winner) => {
    return {
...
exports.displayComparisonResults = function (summoner1, summoner2, compareChampionsResult) {
    ...
    compareChampionsResult.championCompareList.forEach(champion => {
        if (champion.winner == 0) {
            ...
            champion.statList.forEach(result => {
                var wonOrLost = (result.winner > 0 ? "won" : "lost")
                var compareStats = result.statInfo
